    ...
    return (
        <div className="col">
            {props.list.map(data => {
                ...
                return (
                    <div key={conference.href} className="c mb-3 shadow">
                        <img src={conference.location.picture_url} className="card-img" />
    ...
    return (
        <>
            <div className="px-4 py-5 my-5 mt-0 text-center bg-info">
                <img className="bg-white rounded shadow d-block mx-auto mb-4" src="/conference.png" alt="" width="600" />
                <h1 className="display-5 fw-bold">ConnectCon!</h1>
            ...
            <div className="container">
                <h2 className='con'>Upcoming conferences</h2>
                <div className="row">
